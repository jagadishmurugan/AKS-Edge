...
New-Variable -Name gAksEdgeQuickStartForAioVersion -Value "1.0.250116.1500" -Option Constant -ErrorAction SilentlyContinue
...
try {
    ...
    DeployAksEdge -aideUserConfigFile $aideUserConfigFile
